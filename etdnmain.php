...
body {
    ...
    margin: 0;
    padding: 0;
    background-image: url(../../photos/img.jpg.jpg);
    ...
    <main class="cards-container">
        <div class="card">
            <div class="card__content">
                <img src="../../photos/img.jpg.jpg" alt="Results Image" class="card__image"> <!-- Replace 'results.jpg' with your image file -->
                <a href="dow1.php" class="card__title">gerer</a>
                <p class="card__description">accepter supprimer</p>
            </div>
        </div>
        <div class="card">
            <div class="card__content">
                <img src="../../photos/img.jpg.jpg" alt="Moodle Image" class="card__image"> <!-- Replace 'moodle.jpg' with your image file -->
                <a href="afficher.php" class="card__title">tableau des condidats accepter</a>
